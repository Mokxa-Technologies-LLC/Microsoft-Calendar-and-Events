        ...
        try {
            ...
            for (int i = 0; i < events.length(); i++) {
                ...
                if (allDay) {
                    ...
                    startValue = CustomTimeZoneUtil.convertUtcToUserZone(startDate,CURRENT_USERNAME);
                    endValue   = CustomTimeZoneUtil.convertUtcToUserZone(enddate,CURRENT_USERNAME);
                }
