...
public class EventUtil {
    ...
    public EventUtil(String accessToken, String extendedValuePropID,String currentUser){
...
//            LogUtil.info(getClass().getName(), "Cancel Event Body → " + body);
    ...
    public ApiResponse getTodayEvents(int top, int skip,String filterExtendedValue) {
        return listEventsByRange(EventFilterUtil.today(currentUser), top, skip,filterExtendedValue);
    }

    public ApiResponse getThisWeekEvents(int top, int skip,String filterExtendedValue) {
        return listEventsByRange(EventFilterUtil.thisWeek( currentUser), top, skip,filterExtendedValue);
    }

    public ApiResponse getThisMonthEvents(int top, int skip,String filterExtendedValue) {
        return listEventsByRange(EventFilterUtil.thisMonth(currentUser), top, skip,filterExtendedValue);
    }

    public int countTodayEvents(String filterExtendedValue) {
        return countEventsByRange(EventFilterUtil.today(currentUser),filterExtendedValue);
    }

    public int countThisWeekEvents(String filterExtendedValue) {
        return countEventsByRange(EventFilterUtil.thisWeek(currentUser),filterExtendedValue);
    }

    public int countThisMonthEvents(String filterExtendedValue) {
        return countEventsByRange(EventFilterUtil.thisMonth(currentUser),filterExtendedValue);
    }
